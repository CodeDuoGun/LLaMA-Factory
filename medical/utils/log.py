...
redis_pool = redis.ConnectionPool(
    host=config.LOCAL_LOG_REDIS_HOST if config.IS_LOCAL else config.LOG_REDIS_HOST  ,  # Redis 服务器地址
    port=config.LOCAL_LOG_REDIS_PORT if config.IS_LOCAL else config.LOG_REDIS_PORT,  # Redis 服务器端口
    db=config.LOCAL_LOG_REDIS_DB if config.IS_LOCAL else config.LOG_REDIS_DB,  # 数据库编号
    password=config.LOCAL_LOG_REDIS_AUTH if config.IS_LOCAL else config.LOG_REDIS_AUTH,  # 密码
